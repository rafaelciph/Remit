<%@ Page Title="History of remittance" Language="VB" MasterPageFile="~/Site.master" EnableEventValidation="false" AutoEventWireup="false" CodeFile="Remit.aspx.vb" Inherits="Profile_Remit" %>
    ...
    <tr>
        <td width="100%" colspan="2">
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT Document_Date, PH_IDNO, Employee_Name, Amount, Voucher_Number, Description, Remit_Thru, Particulars, Remarks, Trans, Code, Due_Date, Status, Date_Liq FROM Remit_Staff WHERE (PH_IDNO = @PH_IDNO) AND (Code = @Code) ORDER BY Document_Date DESC">
                <SelectParameters>
            ...
            <asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0" 
                ...
                <asp:View ID="View1" runat="server" EnableTheming="False">
                    <asp:Panel ID="Panel2" runat="server" ScrollBars="Horizontal" Width="800px">
                        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                            AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
                            DataSourceID="SqlDataSource1" EmptyDataText="You have no Record/Transaction" 
                            EnableModelValidation="True" ForeColor="#333333" GridLines="None" PageSize="20">
                ...
                <asp:View ID="View2" runat="server" EnableTheming="False">
                    <asp:Panel ID="Panel3" runat="server" ScrollBars="Horizontal" Width="800px">
                        <asp:GridView ID="GridView2" runat="server" AllowPaging="True" 
                            AllowSorting="True" AutoGenerateColumns="False" CellPadding="4" 
                            DataSourceID="SqlDataSource1" EmptyDataText="You have no Record/Transaction" 
                            EnableModelValidation="True" ForeColor="#333333" GridLines="None" PageSize="100">
                            <RowStyle BackColor="#EFF3FB" />
                            <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                            <PagerStyle BackColor="#2461BF" ForeColor="White" HorizontalAlign="Center" />
                            <SelectedRowStyle BackColor="#D1DDF1" Font-Bold="True" ForeColor="#333333" />
                ...
                <asp:View ID="View3" runat="server">
                    <asp:SqlDataSource ID="SqlDataSource_others" runat="server" 
                        ...
                        SelectCommand="SELECT Document_Date, PH_IDNO, Employee_Name, Amount, Voucher_Number, Description, Remit_Thru, Particulars, Remarks, Trans, Code, Due_Date, Status, Date_Exported, Date_Liq FROM Remit_Staff WHERE (PH_IDNO = @PH_IDNO) AND (Code &lt;&gt; @Code) AND (Code &lt;&gt; @Code2) ORDER BY Document_Date DESC">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="lblidno" Name="PH_IDNO" PropertyName="Text" 
                                Type="String" />
                    ...
                    <asp:Panel ID="Panel4" runat="server" ScrollBars="Horizontal" Width="800px">
            ...
            <asp:Button ID="btnprinterallpages" runat="server" Text="Print All Pages" />
&nbsp;<asp:Button ID="btnprintcurrentpage" runat="server" Text="Print Current Page" />
	 &nbsp;<asp:Button ID="Button1" runat="server" Text="Export to Excel" Visible="True" />
            <br />
        </td>
    </tr>
</table>
